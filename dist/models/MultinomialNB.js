...
var MultinomialNB = (exports.MultinomialNB = (function() {
   ...
   */
	function MultinomialNB(model) {
		...
		if (model) {
			this.conditionalProbability = _mlMatrix2.default.checkMatrix(
				model.conditionalProbability,
			);
			this.priorProbability = _mlMatrix2.default.checkMatrix(
		...
		[
			{
				...
				value: function train(trainingSet, trainingLabels) {
					...
					var separateClass = (0, _utils.separateClasses)(
						trainingSet,
						trainingLabels,
					);
					this.priorProbability = new _mlMatrix2.default(
					...
					this.conditionalProbability = new _mlMatrix2.default(
						separateClass.length,
						features,
					);
					for (i = 0; i < separateClass.length; ++i) {
						var classValues = _mlMatrix2.default.checkMatrix(
							separateClass[i],
						);
